...
//            if ([text isEqualToString:_passcode]) {
            if ([_delegate respondsToSelector:@selector(PAPasscodeViewControllerCheckPasscode:withPassword:)]) {
                isCorrectPasscode = [_delegate PAPasscodeViewControllerCheckPasscode:self withPassword: text];
            }
