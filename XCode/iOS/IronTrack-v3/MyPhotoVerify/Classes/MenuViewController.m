...
- (void)viewDidLoad {
    ...
    NSArray *array = [[NSArray alloc] initWithObjects: @"Immagini", @"Certificati", @"Servizi",   nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([indexPath row] == 0) {
		PhotoTableViewController *photoTableViewController= [[PhotoTableViewController alloc] initWithNibName:@"PhotoTableViewController" bundle:nil];
