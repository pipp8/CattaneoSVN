...
CMS_CertificateChoices *CMS_add0_CertificateChoices(CMS_ContentInfo *cms)
	...
	if (!sk_CMS_CertificateChoices_push(*pcerts, cch)) {
		...
		ASN1_item_free(  ((ASN1_VALUE *) (1 ? cch : (CMS_CertificateChoices*)0)), ASN1_ITEM_rptr(CMS_CertificateChoices));
		return NULL;
	}
	return cch;
	}
...
CMS_RevocationInfoChoice *CMS_add0_RevocationInfoChoice(CMS_ContentInfo *cms)
	...
	if (!sk_CMS_RevocationInfoChoice_push(*pcrls, rch)) {
		...
		ASN1_item_free(  ((ASN1_VALUE *) (1 ? rch : (CMS_RevocationInfoChoice*)0)), ASN1_ITEM_rptr(CMS_RevocationInfoChoice));
		return NULL;
	}
	return rch;
	}
