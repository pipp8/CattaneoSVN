     ...
     [tags setObject:tag forKey:[NSNumber numberWithInt:0x0007]];
      ...
      [tags setObject:tag forKey:[NSNumber numberWithInt:0x0008]];
       ...
       [tags setObject:tag forKey:[NSNumber numberWithInt:0x0009]];
        ...
        //Custom tag
	//Firma digitale
	tag = [[EXFTag alloc] initWith:0xF101 : FMT_STRING :@"Sign":-1:  TRUE:-99];
    [tags setObject:tag forKey:[NSNumber numberWithInt:0xF101]];
    [tag release];
	
	//Timestamp from TPA Authority
	tag = [[EXFTag alloc] initWith:0xF102 : FMT_STRING :@"Timestamp":-1:  TRUE:-99];
    [tags setObject:tag forKey:[NSNumber numberWithInt:0xF102]];
    [tag release];
