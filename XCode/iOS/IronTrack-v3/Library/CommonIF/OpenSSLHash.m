...
-(NSData *) SHA256:(NSData *)data {
    ...
    unsigned long messagelen = [data length];
    unsigned char *shaout;
    shaout = (unsigned char*) malloc(SHA256_DIGEST_LENGTH);
    SHA256(message, messagelen, shaout);
    
    NSData *shaData= [NSData dataWithBytes:shaout length:SHA256_DIGEST_LENGTH];
    free(shaout);
