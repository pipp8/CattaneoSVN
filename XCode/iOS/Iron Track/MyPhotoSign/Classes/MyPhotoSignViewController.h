...
@interface MyPhotoSignViewController : UIViewController <UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate,DBLoginControllerDelegate>{
