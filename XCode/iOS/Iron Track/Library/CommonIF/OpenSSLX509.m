...
-(NSString *) getCertSerialNumber:(X509 *) cert  {

	char *data = NULL;

	BIO *wbio = BIO_new(BIO_s_mem());

	i2a_ASN1_INTEGER( wbio, X509_get_serialNumber(cert));
	...
	NSString *serial = [NSString stringWithUTF8String: data];

	// NSData *serial= [NSData dataWithBytes:data length:len];
