...
public class ScoreTable extends javax.swing.JFrame {
    ...
    private void CambioCampo(java.awt.event.ActionEvent evt) {                             
        ...
        winner = Player.NoPlayer;
        fineSet(false);
        pnlSx.setWinner(false);
        pnlDx.setWinner(false);
    ...
    public void fineSet(boolean val) {
        ...
        if (val) {
            ...
            if (winner == Player.PlayerA)
                pnlSx.setWinner( true);
            else
                pnlDx.setWinner( true);
        }
    }
    ...
    private void initManualComponents() {
        ...
        pnlSetSx = new SelfAdjustingPanel( new Color(220, 220, 220), Color.red, null);
        ...
        pnlSetDx = new SelfAdjustingPanel(new Color(220, 220, 220), Color.red, null);
    ...
    public enum Player { PlayerA, PLayerB, NoPlayer };
}
