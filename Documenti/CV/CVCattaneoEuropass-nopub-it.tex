...
\svnid{$Id: CVCattaneoEuropass-nopub-it.tex 917 2024-03-28 21:27:26Z cattaneo $}

\svnkwsave{$LastChangedDate $}

\newcommand{\currentDate}{\svnfileday/\svnfilemonth/\svnfileyear}
\newcommand{\lastYear}{\em 2023} 
...
\begin{document}
  ...
  \ecvbigitem{Motivo}{Redazione Relazione Tecnica di Parte}
...
\ecvsection{Pubblicazioni}
  \ecvtitle{1983--\lastYear}{}
   \ecvitem{} {\`E stato autore di oltre 100 articoli scientifici pubblicati su primarie riviste internazionali o negli atti di convegni scientifici internazionali. Tutti gli articoli sono reperibili on-line.}
%  
