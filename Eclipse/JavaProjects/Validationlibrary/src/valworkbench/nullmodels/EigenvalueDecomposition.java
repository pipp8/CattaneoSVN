...
public class EigenvalueDecomposition implements java.io.Serializable
{
     ...
     * 
     */
    private static final long serialVersionUID = 3905241208589727796L;
  ...
  */
    ...
    private void hqr2()
    {
                ...
                else
                {
                    ...
                    for (int k = m; k <= n - 1; k++)
                    {
                        ...
                        if(s != 0)
                        {
                            ...
                            // Column modification
                            final int minnk = Math.min(n, k + 3);
                ...
                if(q < 0)
                {
                    ...
                    for (int i = n - 2; i >= 0; i--)
                    {
                        ...
                        else
                        {
                            ...
                            t = Math.max(Math.abs(H[i][n - 1]), Math
                                    .abs(H[i][n]));
                            if((eps * t) * t > 1)
                            {
                                for (int j = i; j <= n; j++)
        ...
        for (int j = nn - 1; j >= low; j--)
        {
            ...
            {
                z = 0.0;
                final int minjhigh = Math.min(j, high);
                for (int k = low; k <= minjhigh; k++)
                {
                    z = z + V[i][k] * H[k][j];
                }
                V[i][j] = z;
     ...
     * 
     * @param dim number rows or columns of matrix
     * @param Arg
     *            Square matrix
     */

    public EigenvalueDecomposition(double[][] Arg, int dim)
    {
        A = Arg;
        n = dim;
        compute();
    ...
    final public double[] getRealEigenvalues()
    {
        return d;
    }
    ...
    final public double[] getImagEigenvalues()
    {
        return e;
    }
