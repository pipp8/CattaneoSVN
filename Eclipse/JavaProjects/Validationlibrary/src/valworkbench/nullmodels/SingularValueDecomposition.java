...
public class SingularValueDecomposition implements java.io.Serializable
{
     ...
     * 
     */
    private static final long serialVersionUID = 3257845497862304053L;
     ...
     * @param NumRow number of rows of matrix
     * @param NumCol number of columns of matrix
     */
    public SingularValueDecomposition(double[][] Arg, int NumRow, int NumCol)
    {
        A = Arg;
        m = NumRow;
        n = NumCol;
    ...
    {  
        ...
        final int maxcr = Math.max(nct, nrt);
        for (int k = 0; k < maxcr; k++)
        {
            if(k < nct)
            {
        ...
        while (p > 0)
        {
            ...
            case 3:
            {
                ...
                final double scale = Math.max(Math.max(Math
    ...
    final public double[] getSingularValues()
    {
        return s;
    }
