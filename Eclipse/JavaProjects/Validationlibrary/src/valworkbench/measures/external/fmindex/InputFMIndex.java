...
public class InputFMIndex extends InputMeasure {
	/**
	...
	/**
	 * Constructor method that provide input parameters for F-index execution
	 * 
	 * 
	 ...
	 */
	public InputFMIndex(int kMin, int kMax, String algorithmPath, String algCommandLine, String outputPath, 
	...
	/**
	 * Constructor method that provide input parameters for F-index 
