...
public class InputFIndex extends InputMeasure {
	/**
	 ...
	 */
	public InputFIndex(int kMin, int kMax, String algorithmPath, String algCommandLine, String outputPath, 
