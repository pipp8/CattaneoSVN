...
public class KLGeneric extends KrzanowskiLai {
	private final String MEASURE_NAME = "KL Generic";
	/**
	 * Default constructor
	 *
	 */
	 ...
	 * @see InputMeasure
	 */
	public KLGeneric(DataMatrix dataMatrix, InputMeasure mParameters)
	{
	...
	public MeasureVector computeMeasure() throws FileNotFoundException, IOException, NumberFormatException, Exception 
	{
		...
		WCSSGeneric wCSSGen = new WCSSGeneric(dataMatrix, parameters);
		this.intIndex = wCSSGen.computeMeasure();
