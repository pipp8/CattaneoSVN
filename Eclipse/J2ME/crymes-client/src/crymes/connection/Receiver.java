...
public class Receiver implements MessageListener {
	public static final String PORT = "17002";
	...
	public static final String INCOMMING_STORE_NAME = "jwhisper-a2p-incomming";
		...
		if (msg != null) {
			if (msg instanceof BinaryMessage) {
				try {
					...
					//dvrebbe generare l'eccezione se è un messaggio di tipo non valido...
					//allora a me serve prorpio questo, verificare il tipo per la challenge
