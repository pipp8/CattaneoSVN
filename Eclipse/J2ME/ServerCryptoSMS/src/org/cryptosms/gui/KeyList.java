...
public class KeyList extends List implements CommandListener {
	...
	public KeyList(CryptoSMSMidlet gui) {
		...
		this.importKey = new Command(gui.getResourceManager().getString(ResourceTokens.STRING_IMPORT_KEY), Command.OK,
				0);
		this.delete = new Command(gui.getResourceManager().getString(ResourceTokens.STRING_DELETE_KEY), Command.OK,
				0);
