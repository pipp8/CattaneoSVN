...
public class ReceiverA2P extends Receiver {

	public static final String SERVER_URL_A2P = "sms://:" + Constant.SMS_PORT_A2P;
	
	private ReceiverA2P() {
		super(SERVER_URL_A2P);
	...
	public static Receiver dirtyInit() {
		if (receiver != null) {
			if (receiver.getConnection() != null) {
				...
				return ReceiverA2P.getInstance();
		}
		return null;
	}
