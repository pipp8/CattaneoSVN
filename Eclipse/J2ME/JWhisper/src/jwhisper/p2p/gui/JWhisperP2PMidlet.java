...
import jwhisper.modules.connection.ReceiverP2P;
 ...
 */
public class JWhisperP2PMidlet extends JWhisperMidlet {
...
//	private Display __display = Display.getDisplay(this);
	 ...
	 * @throws
	 */
	public JWhisperP2PMidlet() {
		super (Constant.APPLICATION_TYPE_P2P);
	}
	...
	protected void destroyApp(boolean arg0) throws MIDletStateChangeException {
		...
		// By Fabio
		if (ReceiverP2P.getInstance() != null)
			if (ReceiverP2P.getInstance().getConnection() != null)
				try {
					MessageConnection connection = ReceiverP2P.getInstance().getConnection();
					connection.close();
				} catch (IOException e) {
	...
	protected void startApp() throws MIDletStateChangeException {
		final String SERVER_URL = ReceiverP2P.SERVER_URL_P2P;
		...
		if (connections.length > 0) {
			...
			for (int i=0;i<connections.length;i++) {
				...
				if (SERVER_URL.equals(connections[i])) {
					...
					this.receiver=ReceiverP2P.getInstance(); 
					break;
				}
			}
		} 
		...
		if (this.receiver == null) {
			...
			if (Receiver.isReceiverNull()) {
				...
				this.receiver=ReceiverP2P.dirtyInit();
			}
		}
