...
public class AddressList extends List implements CommandListener {
	private JWhisperP2PMidlet _midlet = null;
	 ...
	 * @throws IOException 
	 */
	public AddressList(JWhisperP2PMidlet midlet)  {
	 ...
	 * @param string
	 */
	public AddressList(JWhisperP2PMidlet midlet, String string) {
