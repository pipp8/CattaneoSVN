...
public class MessageSender extends Thread {
	...
	private MessageSender() {
		...
		MessageSender.log=CGSSLogger.getInstance();
	}
		...
		while (msg != null) {
			try {
				...
				if (receiver != null) {
					...
					jwhisper.cgss.modules.wma.BinaryMessage binary = new jwhisper.cgss.modules.wma.sms.BinaryObject(address);
					...
					CGSSLogger.getInstance().write("no connection available");
				}
			} catch (Exception e) {
				e.printStackTrace();
