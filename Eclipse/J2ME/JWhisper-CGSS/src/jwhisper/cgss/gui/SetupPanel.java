...
public class SetupPanel extends javax.swing.JPanel implements java.awt.event.ActionListener {
    ...
    private void initComponents() {                          
        ...
        textGSMPhoneNumber = new javax.swing.JTextField();
        ...
        textGSMPhoneNumber.setText(CSettings.getNumberSMSC_GSM());
        textGSMPhoneNumber.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        textGSMPhoneNumber.setEnabled(false);
...
//        String wind = "WIND ("+CSettings.getNumberSMSC_WIND()+")";
//        String tim = "TIM ("+CSettings.getNumberSMSC_TIM()+")";
//        String voda = "Vodafone ("+CSettings.getNumberSMSC_VODAFONE()+")";
//        String h3g =  "H3G ("+CSettings.getNumberSMSC_H3G()+")";
        //cgssList.setModel(new javax.swing.DefaultComboBoxModel(new String[] { wind, tim, voda, h3g}));
            ...
            .add(layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                .add(org.jdesktop.layout.GroupLayout.LEADING, textGSMPhoneNumber, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel5)
                    .add(textGSMPhoneNumber, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .add(17, 17, 17)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel2)
...
//    	switch (cgssList.getSelectedIndex()) {
//		case 0:
//			//WIND
//			gsm = CSettings.getNumberSMSC_WIND();
//			break;
//		case 1:
//			//TIM
//			gsm = CSettings.getNumberSMSC_TIM();
//			break;
//		case 2:
//			//VODAFONE
//			gsm = CSettings.getNumberSMSC_VODAFONE();
//			break;
//		case 3: 
//			//H3G
//			gsm = CSettings.getNumberSMSC_H3G();
//			break;
//		}
    	gsm = CSettings.getNumberSMSC_GSM();
    	CSettings.setNumberSMSC_GSM(gsm);
    	...
    	if(name.length() < 2 || emulator.length() < 7|| passphrase.length() < 5 || !passphrase.equals(repeatPass)) {
...
//			}
    ...
    private javax.swing.JTextField textGSMPhoneNumber;
