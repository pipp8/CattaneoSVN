...
public class SmsPanel extends javax.swing.JPanel implements java.awt.event.ActionListener, KeyListener {
	...
	public void keyReleased(KeyEvent e) {
		...
		if (!text.equalsIgnoreCase(text2)){
			...
			if (text2.length() > 200){
				...
				String str = "Superata la lunghezza massima consentita";
