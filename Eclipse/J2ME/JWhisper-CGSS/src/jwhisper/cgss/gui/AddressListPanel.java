...
public class AddressListPanel extends javax.swing.JPanel implements java.awt.event.ActionListener, TableModelListener {
    ...
    private void addRowToAddressList(String name, String number, boolean hasKey, boolean isKeyValid){
    	...
    	//String s = MainFrame.class.getResource("res" + File.separator +  "global" + File.separator + "icons" + File.separator + "nokey.jpg");
    	if (isKeyValid)
    		i=Toolkit.getDefaultToolkit().getImage("res" + File.separator +  "global" + File.separator + "icons" + File.separator + "key.jpg");
    	else if (hasKey)
    		i=Toolkit.getDefaultToolkit().getImage("res" + File.separator + "global"  + File.separator +  "icons"  + File.separator + "challenge.jpg");
    	else{
    		i=Toolkit.getDefaultToolkit().getImage("res" + File.separator +  "global" + File.separator + "icons" + File.separator + "nokey.jpg");
    		
    		
    		//i=Toolkit.getDefaultToolkit().getImage(getClass().getResource("res" + File.separator +  "global" + File.separator + "icons" + File.separator + "nokey.jpg"));
    	}
