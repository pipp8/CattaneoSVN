...
import util.recordstore.InvalidRecordIDException;
...
import util.recordstore.RecordStoreNotOpenException;
...
//	private static CryptoSMSMidlet _midlet;
	 ...
	 * @exception recordstore
	 */
	public static Settings saveSettings(String name, String number, KeyPairHelper pair) throws Exception,
			RecordStoreFullException, RecordStoreException, Exception {
		Settings s = Settings.init(name, number, pair);
	...
	public static CMessage[] getPKRegisterMessages() throws Exception {
		RecordEnumeration e = _messages.enumerateCache(new MessageTypeFilter(MessageType.PK_REGISTER), null);
		return getMessagesFromEnumeration(e);
	}
