...
public class Address {
	...
	public byte[] getBytes() throws Exception {
		...
		*/
		...
		dStrm.writeBoolean(_keyIsValid);
	...
	*/
	...
	public void setPublicKey(byte[] data) {
		...
		//if ( _publicKeyLen > 0){
		_publicKey = new byte[data.length];
		System.arraycopy(data,0, _publicKey,0, data.length);
		//}
		//_publicKey = data;
	...
	public boolean isKeyIsValid() {
		return _keyIsValid;
	}

	public void setKeyIsValid(boolean isValid) {
		_keyIsValid = isValid;
	}
