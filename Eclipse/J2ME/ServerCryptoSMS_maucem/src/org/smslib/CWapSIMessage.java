...
public class CWapSIMessage extends COutgoingMessage
{
	...
	private static final String PDU_PATTERN = "29060603AE81EA8DCA02056A0045C6{URL1}03{URL2}00080103{TEXT}000101";
	...
	public CWapSIMessage(String recipient, URL hRef, Date createDate, Date expireDate, int signal, String text) throws Exception
	{
		...
		this.signal = signal;
		this.text = text;
		setMessageEncoding(CMessage.MessageEncoding.EncUcs2);
		setSourcePort(9200);
	...
	private void fixPdu() throws Exception
	{
		...
		s = bytesToHexStr(text.getBytes("UTF-8"));
