...
public class AddressService {
	...
	private static final String STORE_PERSON = "jwhisper-p2p-adressbook";
	private static final String STORE_NUMBER = "jwhisper-p2p-numbers";
	private static final String STORE_MESSAGE = "jwhisper-p2p-messages";
	private static final String STORE_SETTING = "jwhisper-p2p-settings";
	...
	public static Settings saveSettings(String alg, String name, String number, KeyPair pair) throws Exception,
	RecordStoreFullException, RecordStoreException, Exception {
		Settings s = Settings.init(alg, name, number, pair);
