...
import ejbs.ScheduleItemLocal;
import ejbs.ScheduleItemLocalHome;
 ...
 *           description="Application Front End Session Bean"
	...
	private List wrapScheduleItemsInList(Collection items) {
		...
		while (iterator.hasNext()) {
			...
			ScheduleItemData wrapper = new ScheduleItemData( Integer.valueOf(0),
					...
					scheduleItem.getEndTime(), scheduleItem.getDay(), scheduleItem.getScheduleId());
			list.add(wrapper);
		}
		return list;
	}
