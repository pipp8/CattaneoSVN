...
<body>
<FORM action="/SchoolScheduleCMPWeb/ScheduleServlet" method="post">Schedule<INPUT
...
<FORM method="post" action="/SchoolScheduleCMPWeb/ScheduleServlet">Schedule:<INPUT
	type="text" name="scheduleID" size="20"><br>
<INPUT type="submit" value="Get Schedule"></FORM>


<FORM method="post" action="/SchoolScheduleCMPWeb/ScheduleServlet">Course Name:<INPUT
	type="text" name="nameGet" size="20"><br>
<INPUT type="submit" value="Find Schedules"></FORM>


<FORM method="post" action="/SchoolScheduleCMPWeb/ScheduleServlet"><INPUT
